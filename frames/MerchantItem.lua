...
local function SetValue(self, i)
	...
	if self.backdrop.SetGradientAlpha then
		self.backdrop:SetGradientAlpha("HORIZONTAL", unpack(gradient))
	else
		local r1,g1,b1,a1,r2,g2,b2,a2 = unpack(gradient)
		local from,to = CreateColor(r1,g1,b1,a1), CreateColor(r2,g2,b2,a2)
		self.backdrop:SetGradient("HORIZONTAL", from, to)
	end
